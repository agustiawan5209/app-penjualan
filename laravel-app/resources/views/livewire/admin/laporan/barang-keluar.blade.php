        ...
        <div class="container mx-auto">
            <div date-rangepicker="" class="flex items-center">
             ...
             <div class="flex justify-between w-full px-4 py-2">
                 ...
                 <a href="{{route('Laporan-Barangkeluar', ['start'=> $startDate, 'end'=> $maxDate])}}" class="px-2 py-2 text-white bg-red-500 rounded-md hover:bg-red-600">
