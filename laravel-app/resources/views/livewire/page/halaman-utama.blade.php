                ...
                <div class="justify-center flex flex-wrap -mx-4">
                    <div class="px-12 relative w-full md:w-8/12">
                        ...
                        <p class="text-xl leading-relaxed opacity-75 mt-1 mb-4">Menjual Bahan Bangunan & Alat-alat
                            Listrik</p>
                        <a href="{{route('shop')}}"
                            class="inline-block outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase border border-solid font-bold last:mr-0 mr-2  text-white bg-red-500 border-red-500 active:bg-red-600 active:border-red-600 text-sm px-6 py-2 shadow hover:shadow-lg rounded-md"><i
