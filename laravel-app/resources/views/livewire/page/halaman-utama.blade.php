<main>
    <div class="w-full">
        <section class="flex relative items-center p-0 min-h-screen z-0">
           ...
           <div class="bg-gray-800 w-full h-full absolute bg-cover bg-50" style="background-image: url({{asset('img/mufid-majnun-5QFq8wOLpqE-unsplash.jpg')}});"></div>
           <div class="relative h-full text-center text-white container mx-auto px-4 z-2 mb-24">
              <div class="justify-center flex flex-wrap -mx-4">
                 <div class="px-12 px-4 relative w-full md:w-8/12">
                    <h1 class="text-5xl font-bold leading-tight mt-0 mb-2"><x-jet-application-logo /></h1>
                    <p class="text-xl leading-relaxed opacity-75 mt-1 mb-4">Menjual Bahan Bangunan & Alat-alat Listrik</p>
