            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap -mx-4">
                    @foreach ($produk as $item)
                        <div class=" relative w-1/2 md:w-[30%] shadow-lg cursor-pointe bg-white"
                            ...
                            <div class="relative flex flex-col min-w-0 break-words w-full bg-transparent">
                                ...
                                <div class="py-6 px-5 flex-auto text-left bg-green-400">
                                    <h5 class=" text-xs md:text-2xl text-center font-bold mt-0 bg-white"><a
                                            href="javascript:;"
                                            class="text-black  w-full border-b border-white">{{ $item->nama_barang }}</a>
                                    </h5>
                                    <h5 class=" md:text-lg border-b text-white text-sm">Jenis
                                        :{{ $item->katalog->nama_katalog }}</h5>
