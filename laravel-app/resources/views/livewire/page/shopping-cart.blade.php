        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg">
            <div class="px-4 py-5 flex-auto">
                ...
                <div class="items-center my-4 flex items-start">
                    ...
                    <div class="flex-1">
                        <div class="justify-between">
                            ...
                            <p class="text-blueGray-500 uppercase font-bold text-xs">Jumlah : {{$item->quantity}}</p>
                        </div>
                    </div>
                    <span class="text-blueGray-700">Rp. {{number_format($item->sub_total,0,2)}}</span>
                </div>
                @endforeach
                ...
                <div>
                    ...
                    <div class="flex justify-between">
                        <h6 class="text-blueGray-700 leading-normal mt-0 mb-2">Diskon</h6>
