    ...
    <div class="py-12 bg-reddarken-100">
      <div class="flex flex-wrap -mx-4">
        <div class="flex justify-center flex-col px-4 relative w-full md:w-4/12 ml-auto">
          ...
          <p class="mt-2 mb-10 text-lg leading-relaxed text-reddarken-400">You have Free Unlimited Updates and Premium Support on each package. You also have 20 days to request a refund.</p>
          <div><button class="inline-block outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase border border-solid font-bold last:mr-0 mr-2  text-white bg-pink-500 border-pink-500 active:bg-pink-600 active:border-pink-600 text-sm px-6 py-2 shadow hover:shadow-lg rounded-md">Freelancer</button>
            <button class="inline-block outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase border border-solid font-bold last:mr-0 mr-2  text-reddarken-800 bg-white border-white active:bg-reddarken-100 active:border-reddarken-100 text-sm px-6 py-2 shadow hover:shadow-lg rounded-md">Enterprise</button>
          </div>
        </div>
                ...
                @foreach ($promo as $promo)
                    <div class="px-4 relative w-full md:w-6/12">
                      <div class="bg-white mb-6 text-center shadow-lg rounded-lg relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg">
                        ...
                        {{-- <div class="mt-4 bg-transparent rounded-b px-4 py-3 border-t border-reddarken-200">
