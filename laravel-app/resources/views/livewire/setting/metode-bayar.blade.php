                ...
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            wire:model="nama_pemilik" type="text" placeholder="Username">
                    </div>
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            wire:model="nama_bank" type="text" placeholder="******************">
                    </div>
                    <div class="mb-6">
                        ...
                        <input
                            class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                            wire:model="no_rek" type="text" placeholder="******************">
                    </div>
            ...
            <tbody>
                @foreach ($bank as $bank)
                    <tr>
                        ...
                        <x-tr>{{ $bank->nama_pemilik }}</x-tr>
                        <x-tr>{{ $bank->nama_bank }}</x-tr>
                        <x-tr>{{ $bank->no_rek }}</x-tr>
                        <x-tr>
                            <button wire:click='editModal({{ $bank->id }})'
                            ...
                            <button wire:click='deleteModal({{ $bank->id }})'
