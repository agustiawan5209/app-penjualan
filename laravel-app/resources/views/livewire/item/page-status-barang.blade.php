    ...
    @if ($barang_id != null || $barang_id != '' || $barang_id != 0)
        <form
            ...
            <footer class="flex items-center justify-between px-6 py-4">
                ...
                <button wire:click="$toggle('status')" wire:loading.attr='disabled' class="px-5 py-3 text-sm font-medium text-white bg-red-600 rounded-lg" type="submit">
                    Tutup
                </button>
            </footer>
        </form>
                        ...
                        <li>
                            <div class="md:flex flex-start">
                                ...
                                <div class="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10">
                                    <div class="flex justify-between mb-4">
                                        <a href="#!"
                                            class="font-medium text-blue-600 hover:text-blue-700 focus:text-blue-800 duration-300 transition ease-in-out text-sm">Status Pengiriman</a>
                                        <a href="#!"
                                    ...
                                    <p class="text-gray-700 mb-6">{{$item->ket == null ? 'Keterangan Kosong' : $item->ket}}.</p>
                                    {{-- <button type="button"
                                        class="inline-block px-4 py-1.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                                        data-mdb-ripple="true">Preview</button>
                                    <button type="button"
