<x-guest-layout>
<div class="w-full ct-docs-disable-nav-fixed">
    <nav class="w-full z-50 flex flex-wrap items-center justify-between px-2 py-3 bg-reddarken-800 shadow-md">
       <div class="flex container mx-auto flex flex-wrap items-center justify-between px-0 lg:px-4">
          <a class="text-sm font-bold leading-relaxed inline-flex items-center mr-4 py-2 whitespace-nowrap uppercase text-white" href="#/"><img src="{{asset('img/banner_img_03.jpg')}}" class="rounded-full mr-2" style="width: 30px;"><span>Creative Tim</span></a><button class="ml-auto cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-reddarken-400 rounded bg-transparent block outline-none focus:outline-none text-reddarken-300 lg:hidden" type="button"><i class="fas fa-bars"></i></button>
             ...
             <ul class="lg:items-center flex flex-wrap list-none pl-0 mb-0 flex flex-col list-none pl-0 mb-0 lg:flex-row">
                ...
                <li class="relative">
                   ...
                   <div class="hidden  z-50">
                      <div class="origin-top-right bg-white text-base float-left p-2 border list-none text-left rounded-lg shadow-lg min-w-48 transition-all duration-100 ease-in-out transform scale-95 opacity-0 absolute "><span class="uppercase font-bold text-xs px-3 pt-4 block w-full whitespace-nowrap bg-transparent text-reddarken-400">Group 1</span><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 1</a><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 2</a><span class="uppercase font-bold text-xs px-3 pt-4 block w-full whitespace-nowrap bg-transparent text-reddarken-400">Group 2</span><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 3</a><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 4</a><span class="uppercase font-bold text-xs px-3 pt-4 block w-full whitespace-nowrap bg-transparent text-reddarken-400">Group 3</span><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 5</a><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 6</a><span class="uppercase font-bold text-xs px-3 pt-4 block w-full whitespace-nowrap bg-transparent text-reddarken-400">Group 4</span><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 7</a><a href="javascript:;" class="text-sm px-3 py-2 block w-full whitespace-nowrap bg-transparent hover:bg-reddarken-100 rounded transition-all duration-100">Demo Page 8</a></div>
                   </div>
                </li>
             </ul>
    ...
    <div class="h-screen overflow-hidden">
       <div class="absolute bg-cover bg-50 h-full w-full" style="background-image: url('../assets/img/illustrations/404.svg');"></div>
       <div class="container mx-auto px-4 h-full">
          <div class="flex flex-wrap -mx-4 h-full items-center">
             <div class="text-center px-4 relative w-full">
                <h1 class="font-bold text-10 sm:text-12 tracking-875 text-reddarken-800">404</h1>
                <h4 class="text-3xl font-bold mb-2 mt-0">Page not found :(</h4>
                <p class="text-2xl font-normal leading-normal text-reddarken-500">Ooooups! Looks like you got lost.</p>
             </div>
          </div>
       </div>
    </div>
