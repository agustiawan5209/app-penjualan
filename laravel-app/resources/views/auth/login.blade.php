<x-guest-layout>
    <div class="container mx-auto flex justify-center pt-10 mt-20">
        <div class="w-full md:w-1/2 bg-white text-white shadow-lg rounded-lg">
            <form action="{{route('login')}}" method="POST" class="relative flex flex-col min-w-0 break-words w-full mb-6  bg-reddarken-100 border-gray-800 border-y">
                @csrf
                    ...
                    <form>
                        <div class="relative w-full">
                            ...
                            <div class="mb-3 pt-0"><input placeholder="Email" name="email" type="email"
                                    class="border-gray-300 shadow px-3 py-2 text-sm  w-full placeholder-gray-200 text-gray-700 relative bg-white rounded-md outline-none focus:ring focus:ring-lightBlue-500 focus:border-lightBlue-500 border border-solid transition duration-200 ">
                            </div>
                        </div>
                        <div class="relative w-full">
