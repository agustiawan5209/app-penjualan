<ul class="md:flex-col md:min-w-full flex flex-col list-none">
    ...
    <li class="items-center  ">
        <a href="{{ route('Customer.Dashboard-User') }}"
            class="text-xs uppercase py-3 pl-3 font-bold block {{ request()->routeIs('Customer.Dashboard-User') ? ' bg-red-darken text-white' : 'text-gray-700 hover:text-gray-500' }}">
            {{-- <i class="fas fa-tv mr-2 text-sm opacity-75"></i> --}}
            Dashboard
        </a>
    </li>
    <li class="items-center" >
        <a href="{{route('Customer.Pesanan')}}"
            class="text-xs uppercase py-3 font-bold block {{ request()->routeIs('Customer.Pesanan')? ' bg-red-darken text-white' : 'text-gray-700 hover:text-gray-500' }}">
            <i class=" mr-2 text-sm text-gray-300"></i>
            Pesanan
        </a>
        {{-- <ul class="md:flex-col md:min-w-full flex flex-col list-none bg-red-darken" x-show="Master" x-transition>
    ...
    <li class="items-center" >
        <a href="{{route('Customer.Kiriman-Barang')}}"
            class="text-xs uppercase py-3 font-bold block {{ request()->routeIs('Customer.Kiriman-Barang')   ? ' bg-red-darken text-white' : 'text-gray-700 hover:text-gray-500' }}">
            <i class=" mr-2 text-sm text-gray-300"></i>
            Kiriman Barang
        </a>
        {{-- <ul class="md:flex-col md:min-w-full flex flex-col list-none bg-red-darken" x-show="Master" x-transition>
